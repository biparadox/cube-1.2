...
int defenum_get_text_value(void * addr,char * text,void * elem){
...
int defenum_set_text_value(void * addr,void * text,void * elem){
	struct elem_template * elem_attr=elem;
	struct struct_elem_attr * elem_desc = elem_attr->elem_desc;
	int enum_value;
	NAME2VALUE * enum_list;
...
{
//	.calculate_offset=Calculate_offset,
	.get_text_value = defenum_get_text_value,
	.set_text_value = defenum_set_text_value,
};
